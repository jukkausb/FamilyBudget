    ...
    public static class SitemapHelper
    {
        public static Sitemap GetSitemap()
        {
            List<SitemapEntry> menuList = new List<SitemapEntry>
            {
                ...
                new SitemapEntry { Id = "pageIncome", Url = "/Income", Title = "Доходы", IconCssClass = "fa-ruble-sign" },
                new SitemapEntry { Id = "pageExpenditure", Url = "/Expenditure", Title = "Расходы", IconCssClass = "fa-ruble-sign" },
                new SitemapEntry { IsDivider = true },
