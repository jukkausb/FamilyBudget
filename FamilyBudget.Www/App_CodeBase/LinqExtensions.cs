...
namespace FamilyBudget.Www.App_CodeBase
{
    ...
    public static class JoinedEnumerable
    {
        ...
        public static JoinedEnumerable<TElement> Wrap<TElement>(this IEnumerable<TElement> source, bool isOuter)
        {
        ...
        public static IEnumerable<TResult> Join<TOuter, TInner, TKey, TResult>(this JoinedEnumerable<TOuter> outer,
        ...
        public static IEnumerable<TResult> LeftOuterJoin<TOuter, TInner, TKey, TResult>(this IEnumerable<TOuter> outer,
            IEnumerable<TInner> inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector,
            Func<TOuter, TInner, TResult> resultSelector, IEqualityComparer<TKey> comparer = null)
        {
